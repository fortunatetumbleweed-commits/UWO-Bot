...
V11 = REPO / "data/heading_cnn_v12_real_occluders_2026-07-02/best.pt"  # actually v12
...
def main():
    ...
    html = f"""<!doctype html>
<meta charset='utf-8'>
<title>Hard cases — v12 vs v10 vs motion</title>
<style>
...
<h1>Hard cases — v12 vs v10 vs motion bearing</h1>
...
<div class='legend'>
 ...
 <p>
   ...
   <span class='v11'>■ green</span> = v12 (new CNN, inferred now) &nbsp;·&nbsp;
...
<table>
 <tr><th>tick</th><th>frame</th><th>v10</th><th>v12</th>
     <th>motion</th><th>|Δ v10-v11|</th><th>flag</th></tr>
 {''.join(row_html(r) for r in rows)}
</table>
"""
    out = REPO / "data/heading_hard_cases/v12_vs_v10.html"
    out.write_text(html)
    print(f"wrote {out}")
